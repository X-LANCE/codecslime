...
cross_page.forEach((page, index) => {
  page.setAttribute('role', 'tab');
  page.setAttribute('aria-selected', index === 0 ? 'true' : 'false');
});
cross_page.forEach((page) => {
  page.addEventListener('click', () => {
    ...
    cross_page[pageNumber-1].setAttribute('aria-selected', 'true');
